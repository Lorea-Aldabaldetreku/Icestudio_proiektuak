  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "33c62d79-d327-4416-86e3-145de5b0a5a8",
          "type": "basic.code",
          "data": {
            "code": "// Up-Down counter\nreg [3:0] counter = 0;\n\n always @(posedge clk) begin\n   if ((up == 1) && (counter < MAX+1))\n     counter <= counter + 1;\n   else\n     if ((down ==1) && (counter > 1))\n       counter <= counter - 1;\n end\n\n assign zenbat = counter - 1;",
            "params": [
              {
                "name": "MAX"
              }
        ...
        {
          "id": "3f9736a7-2939-4aed-91c4-a8a00fd1a728",
          "type": "basic.output",
          "data": {
            "name": "led",
            "range": "[3:0]",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "33c62d79-d327-4416-86e3-145de5b0a5a8",
            "port": "up"
          }
        },
        {
        ...
        },
        {
          ...
          "target": {
            "block": "3f9736a7-2939-4aed-91c4-a8a00fd1a728",
            "port": "in"
          },
          "size": 4
        },
