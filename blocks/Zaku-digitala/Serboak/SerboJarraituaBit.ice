{
  "version": "1.1",
  "package": {
    "name": "serboJarraitua Bit",
    "version": "",
    "description": "Bit 0 orratzen alde eta Bit 1 orratzen aurka",
    "author": "",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "b9140727-bd1c-48e0-87db-c32f4e7bb9f4",
          "type": "basic.input",
          "data": {
            "name": "",
            "pins": [
        ...
        {
          "id": "547d01aa-1ba4-4903-ad1f-84ceba32f5e3",
          "type": "basic.input",
          "data": {
            "name": "on_off",
            "pins": [
        ...
        {
          "id": "f25db56d-5bed-4843-a6f4-0c681da18485",
          "type": "basic.output",
          "data": {
            "name": "",
            "pins": [
        ...
        {
          "id": "4fce0b42-141b-4e7c-af29-280b385cbf09",
          "type": "basic.input",
          "data": {
            "name": "norantz",
            "pins": [
      ...
      "wires": [
        {
          "source": {
            "block": "b9140727-bd1c-48e0-87db-c32f4e7bb9f4",
            "port": "out"
          },
          "target": {
            "block": "d22efd20-9464-4a52-96db-584272e51ec7",
            "port": "clk"
          }
        },
        {
          "source": {
            "block": "547d01aa-1ba4-4903-ad1f-84ceba32f5e3",
            "port": "out"
          },
          "target": {
            "block": "d22efd20-9464-4a52-96db-584272e51ec7",
        ...
        {
          "source": {
            "block": "4fce0b42-141b-4e7c-af29-280b385cbf09",
            "port": "out"
          },
          "target": {
            "block": "d22efd20-9464-4a52-96db-584272e51ec7",
        ...
        },
        {
          ...
          "target": {
            "block": "f25db56d-5bed-4843-a6f4-0c681da18485",
            "port": "in"
          }
        }
      ]
