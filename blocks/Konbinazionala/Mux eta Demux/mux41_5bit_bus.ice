{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "2f43716b-9670-4bc5-9324-1513cf0eaa6a",
          "type": "basic.input",
          "data": {
            "name": "i0",
            "range": "[4:0]",
        ...
        {
          "id": "19d10e52-cd07-49e7-b74f-24a8fd7294ed",
          "type": "basic.input",
          "data": {
            "name": "i1",
            "range": "[4:0]",
        ...
        {
          "id": "c4842d63-6c3c-4aed-bc9d-a059101d4676",
          "type": "basic.input",
          "data": {
            "name": "i2",
            "range": "[4:0]",
        ...
        {
          "id": "87df2ef2-711c-4e98-a821-59dfe966adc9",
          "type": "basic.output",
          "data": {
            "name": "o",
            "range": "[4:0]",
        ...
        {
          "id": "22a0efa6-4fd2-43b2-a088-016501b9a161",
          "type": "basic.input",
          "data": {
            "name": "i3",
            "range": "[4:0]",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "2f43716b-9670-4bc5-9324-1513cf0eaa6a",
            "port": "out"
          },
          "target": {
            "block": "5a8b306e-5a9e-4629-a23f-8d090c574bbd",
        ...
        {
          "source": {
            "block": "19d10e52-cd07-49e7-b74f-24a8fd7294ed",
            "port": "out"
          },
          "target": {
            "block": "5a8b306e-5a9e-4629-a23f-8d090c574bbd",
        ...
        {
          "source": {
            "block": "c4842d63-6c3c-4aed-bc9d-a059101d4676",
            "port": "out"
          },
          "target": {
            "block": "5a8b306e-5a9e-4629-a23f-8d090c574bbd",
        ...
        {
          "source": {
            "block": "22a0efa6-4fd2-43b2-a088-016501b9a161",
            "port": "out"
          },
          "target": {
            "block": "5a8b306e-5a9e-4629-a23f-8d090c574bbd",
        ...
        },
        {
          ...
          "target": {
            "block": "87df2ef2-711c-4e98-a821-59dfe966adc9",
            "port": "in"
          },
          "size": 5
        }
